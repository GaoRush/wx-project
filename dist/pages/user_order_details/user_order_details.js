...
Page({
  ...
  // 订单详情
  user_order_details: function user_order_details() {
    var that = this;
    var api = 'user_order_details';
    ...
    var urlData = {
      ...
      if (order_details.mobile) {
        var mobile = order_details.mobile;
  ...
  edit_order_status: function edit_order_status(e) {
    ...
    // 订单编号
    var order_no = that.data.order_details.order_no;
  ...
  // 点击复制文本
  bind_copy: function bind_copy() {
    var that = this;
    var express_no = that.data.order_details.express_no;
    wx.setClipboardData({
      data: express_no,
      success: function success(res) {
        wx.getClipboardData({
  ...
  order_submit_detail: function order_submit_detail() {
    var that = this;
    // 订单编号，订单总额
  ...
  hide_pay_tips: function hide_pay_tips() {
    var that = this;
    that.setData({
      pay_status: ""
    });
