...
Component({
  ...
  methods: {
    ...
    cart_submit: function () {
      ...
      let goods_id = that.data.goods_obj.id
      let id_list = '';
    ...
    get_address_list: function () {
      ...
      login.requestP_pro({
        ...
        if (!address_list.length > 0) {
          let url = "../../pages/address_list/address_list"
    ...
    gb_buy_now: function () {
      ...
      // 团购结算参数转字符串传参
      let urlData_str = JSON.stringify(urlData)
